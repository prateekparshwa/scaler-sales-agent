...
Live: https://scaler-sales-agent-fawn.vercel.app · Repo: https://github.com/prateekparshwa/scaler-sales-agent · Loom: `https://www.loom.com/share/4035818b1d3843baba50a24554c1de52`

> **Before you test the live app:** WhatsApp delivery uses the Twilio Sandbox. From the WhatsApp number you want messages on, send `join <phrase>` to `+1 415 523 8886` to opt-in "join loud-church". The dashboard's onboarding screen asks for your number after that.
