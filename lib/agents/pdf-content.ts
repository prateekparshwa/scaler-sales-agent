...
11. FEE FIGURES — TRANSCRIPT OVERRIDES CORPUS: If the call transcript mentions a specific fee amount (e.g. "3.5 L", "3.5 lakh", "Rs. 3,50,000"), use THAT figure in the PDF. Do NOT substitute it with the corpus sticker price (₹3,99,000) — the BDA may have quoted a negotiated, promotional, or rounded figure on the call, and contradicting it in the PDF destroys trust. If no fee figure appears in the transcript, use the corpus figure.
